...
<p align="center">
  ...
  <a href="https://github.com/alexar76/aimarket-playground/blob/main/LICENSE"><img src="https://raw.githubusercontent.com/alexar76/aimarket-playground/main/docs/badges/license.svg" alt="License: MIT" /></a>
</p>
<!-- /aicom-readme-badges -->
...
developer with one real invoke. `create-aimarket-agent` then creates a repository the developer
owns. The generator currently runs from the monorepo source; it is not published to PyPI yet, so
the short `uvx create-aimarket-agent ...` command is explicitly presented as post-release.
