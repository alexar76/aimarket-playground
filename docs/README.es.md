...
Ahora el generador se ejecuta desde el código fuente del monorepo y aún no está publicado en PyPI;
el comando corto `uvx create-aimarket-agent ...` funcionará después de la publicación. Son etapas
conectadas, no portales duplicados.
